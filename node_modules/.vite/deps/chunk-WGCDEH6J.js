...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React16.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime9.jsxs)(React16.Fragment, {
  ...
  const Grid2 = React18.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime11.jsx)(GridRoot, {
      ...
      children: React18.Children.map(children, (child) => {
        var _a;
        if (React18.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WGCDEH6J.js.map
